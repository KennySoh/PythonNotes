# -*- coding: utf-8 -*-
"""
Created on Sun Mar 19 00:17:51 2017
...
xdata = "xdata{}{}{}.dat".format(4,0,0)
ydata = "ydata{}{}{}.dat".format(4,0,0)
zdata = "zdata{}{}{}.dat".format(4,0,0)
magdata = "density{}{}{}.dat".format(4,0,0)
...
for a in range(0,len(mag)):
    for b in range(0,len(mag)):
        for _c in range(0,len(mag)):
            ax.scatter(x[a][b][_c],y[a][b][_c],z[a][b][_c], marker='o',alpha =(mag[a][b][_c]/np.amax(mag)))
plt.savefig('{}{}{}_matp.png'.format(4,0,0))